  ...
  methods: {
    onSubmit () {
      ...
      this.$store.dispatch('findIngredient', { food: ing })
        .then(() => {
          if (this.$store.state.findIngredient) {
            console.log('found it', ing)
            this.found = true
          } else if (this.$store.state.findProposedIngredient) {
    ...
    onFocus () {
      console.log('onFocus')
      this.found = false
      this.$store.state.findIngredient = null
      this.$store.state.findProposedIngredient = null
      this.$store.state.addIngredient = null
      this.notFound = false
      this.foundInProposed = false
    },
    resetSearch () {
